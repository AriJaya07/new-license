      ...
      <Card className="p-6 bg-gradient-to-br from-primary-50 to-primary-100 border-2 border-primary-200">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-3xl font-bold text-primary-900">{totalSupply?.toString() || "0"}</p>
          </div>
...
export function PreviewCard({
  ...
  return (
    <Card className="p-6 shadow-xl border-2 border-gray-100">
      ...
      <h4 className="font-bold text-lg mb-2">{description.split("\n")[0] || "NFT Name"}</h4>
      ...
      <div className="flex gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-amber-800">
            By submitting, you confirm that you own all rights to this content or have permission to
            mint it as an NFT. Fraudulent submissions will be rejected and may result in account
            suspension.
          </p>
        </div>
      </div>
